...
<div style="margin-bottom: 24px; padding: 14px 18px; background: #1a1d27; border: 1px solid #c8a45a; border-radius: 8px;">
  ...
  <a href="/ece109_study_reference.pdf" style="color: #c8a45a; font-size: 15px; font-weight: 600;">Study Reference (PDF)</a>
  <span style="margin: 0 8px; color: #555;">|</span>
  <a href="/ece109_comprehensive_reference.pdf" style="color: #c8a45a; font-size: 15px; font-weight: 600;">Comprehensive Reference (PDF)</a>
  <div style="color: #9498ac; font-size: 12px; margin-top: 6px;">Not official formula sheets, just compilations of equations and variables from these lessons. Reminder: you must handwrite your formula sheet.</div>
</div>
<ul>
...
cp ece109_study_reference.pdf "$OUT/" 2>/dev/null || echo "Warning: study reference PDF not found"
cp ece109_comprehensive_reference.pdf "$OUT/" 2>/dev/null || echo "Warning: comprehensive reference PDF not found"
